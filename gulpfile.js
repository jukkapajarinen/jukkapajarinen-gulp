...
const icons = () => gulp.src("./node_modules/@fortawesome/fontawesome-free/webfonts/*.ttf")
  .pipe(gulp.dest("./_build/fonts"));
const images = () => gulp.src("./images/**/*").pipe(gulp.dest("./_build/images"));
const pages = () => gulp.src("./pages/index.html").pipe(gulp.dest("./_build"));
const static = gulp.parallel(fonts, icons, images, pages);
const styles = () => gulp.src("./styles/**/*.*css")
...
/**********************************************************************/
const clean = () => gulp.src("./_build", { read: false, allowEmpty: true })
  .pipe(plugins.clean());
